...
1. OpenAI: "Your data is your data. Data sent to the OpenAI API is not used to train or improve OpenAI models". See [Enterprise Privacy at OpenAI](https://developers.openai.com/api/docs/guides/your-data).
