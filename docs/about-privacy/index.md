...
At Mammouth, we focus on providing two main guarantees about the prompts from Mammouth:

- No training of models with prompts from Mammouth.
- Data non-retention policy: Providers do not retain Mammouth prompts beyond 30 days, generally to monitor service abuse via logs.
