...
The data controller for your personal data is **Mammouth AI SAS**, a company incorporated in France, having its registered office at 8 Rue Dupleix, 75015 Paris, France, registered with the Paris Trade and Companies Register (RCS) under SIREN number 932 983 968. If you have questions about this Privacy Policy or want to exercise your rights, you can contact us at dpo@mammouth.ai.
...
Mammouth may share your Personal Data with the following recipient categories, as necessary for the purposes described above:

1. **AI model providers**: Providers that process prompts, conversations, files, and related information to generate AI responses, including OpenAI, Anthropic, Mistral AI, Google, Fireworks AI, xAI, and OpenRouter.
2. **Payment processors**: Providers that process subscription payments, billing information, and fraud-prevention data, including Stripe or Apple Pay.
3. **Email delivery providers**: Providers that deliver transactional and service communications, including Sendinblue and Resend.
4. **Cloud infrastructure and hosting providers**: Providers that host, store, secure, and support the Services and related files, including Hetzner, Neon, Cloudflare, and Google Cloud Platform.
5. **Public authorities and other recipients required by law**: We may disclose your data to a court, regulator, law-enforcement authority, or other recipient when required by law, a court order, or other legal process.

The current provider names, processing activities, and locations are listed in the [Annex: List of Sub-Processors](../terms-of-service/#annex-list-of-sub-processors) to our Terms of Service. We may update that list as providers are added or replaced, subject to applicable legal requirements.
...
Under Article 22 of the GDPR, you have the right not to be subject to a decision based solely on automated processing, including profiling, that produces legal or similarly significant effects concerning you.

Mammouth AI does **not** engage in such processing. Specifically:

- **AI outputs are advisory**: The responses generated by our AI models are informational and assistive only. They do not constitute automated decisions and have no legal or similarly significant effect on you.
- **No automated profiling affects your rights**: We do not use automated profiling to determine your pricing, account access, subscription eligibility, or any other right or service to which you are entitled. Pricing, account status, and access decisions are made by humans or are the direct result of your explicit subscription choices.
