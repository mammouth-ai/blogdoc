...
- En mode standard, Mammouth récupère les extraits les plus pertinents de vos fichiers (jusqu'à environ 30 000-60 000 caractères selon la requête)
- Pour les documents très volumineux, Mammouth bascule automatiquement en **mode agentique** : au lieu d'un extrait de taille fixe, le modèle dispose d'outils pour parcourir et rechercher directement dans l'intégralité du document, afin de ne manquer aucun contenu pertinent. Le seuil de taille qui déclenche ce mode dépend du modèle utilisé :
  - ~30 000 caractères pour les modèles premium
  - ~150 000 caractères pour les modèles standards
  - ~1 000 000 caractères pour les modèles légers
