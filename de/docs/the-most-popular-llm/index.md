# Welches LLM ist am beliebtesten?

Der LLM Popularity Index wird seit September 2024 jeden Monat von Mammouth AI aktualisiert.

Wir haben bereits [die Methodik des LLM Popularity Index vorgestellt](/de/docs/introducing-llm-popularity-index/).
...
<div class="notes">
        <h4>Bemerkenswerte Ereignisse:</h4>
        <ul>
            <li>Veröffentlichung von DeepSeek</li>
        </ul>
</div>
...
<div class="notes">
        <h4>Bemerkenswerte Ereignisse:</h4>
        <ul>
            <li>Updates für GPT-o1, Llama 3.3 und Gemini 2.0</li>
        </ul>
</div>
...
<div class="notes">
        <h4>Bemerkenswerte Ereignisse:</h4>
        <ul>
            <li>Updates für Mistral Large 2 und GPT-4o</li>
        </ul>
        <ul>
            <li>Grok wurde hinzugefügt</li>
        </ul>
</div>
...
<div class="legend">
    ...
    <div class="notes">
        <h4>Bemerkenswerte Ereignisse:</h4>
        <ul>
            <li>Neue Version von Claude 3.5 Sonnet veröffentlicht</li>
        </ul>
    </div>
